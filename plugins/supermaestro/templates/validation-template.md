...
| `superpowers:verification-before-completion` | Gate 3/Gate 4/completion claims | pending / used |  |
| `superpowers:finishing-a-development-branch` | Gate 4 final actions | pending / used / not-needed |  |
