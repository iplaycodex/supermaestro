...
11. 输出简短的 Gate 1 Requirement Alignment Brief，只确认需求理解、范围、规则、例子、推断项和验收场景；不要在 Gate 1 用任务计划细节替代需求对齐。
12. Gate 1 通过后再生成或确认任务计划、进度表、Review Pack 骨架和验证报告，并进入 Gate 2 计划确认。
