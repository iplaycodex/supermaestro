...
| --- | --- | --- | --- | --- | --- | --- |
|  | API / mock / route / component / model / utility |  | specs/api-contract.md / specs/ui-schema-extract.md | F1 | pending |  |

## 缺口与冲突

| 类型 | 描述 | 影响页面/模块 | 当前处理 | 是否阻塞 Scope Gate |
| --- | --- | --- | --- | --- |
...
- 若 API 只知道入口地址但未解析到接口清单，Scope Gate 应标为 `blocked` 或 `partial`，并说明继续规划的风险。
